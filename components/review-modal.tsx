...
export function ReviewModal({ gameId, userId, isOpen, onClose }: ReviewModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-[102] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-300">
            <div className="w-full max-w-lg glass-card-premium rounded-2xl overflow-hidden border-t border-white/20 shadow-4xl animate-in zoom-in-95 duration-300">
